...
public class PieceVals : MonoBehaviour {
	...
	int[][] pieceSquareTable = new int[][]{
		...
		{0, 0, 0, 0, 0, 0, 0, 0,
			...
			5,-5, -10, -5, -5,-10, -5, 5,
			0, 0, 0, 20, 20, 0, 0, 0, 5,
			5, 10, 25, 25, 10, 5, 5, 10, 10, 20, 30, 30, 20, 10, 10,
		...
		{0, 0, 0, 0, 0, 0, 0, 0, 50, 50, 50, 50, 50, 50, 50, 50, 10, 10, 20, 30, 30, 20, 10,
			...
			0, 0, 0, 0, 0, 0, 0, 0},
		new int []
		{-50, -40, -30, -30, -30, -30, -40, -50, -40, -20, 0, 0, 0, 0, -20, -40, 0, 0, 10, 15, 
			15, 10, 0, -30, -30, 5, 15, 20, 20, 15, 5, -30, -30, 0, 15, 20, 20, 15, 0, -30, 
			-30,5, 5, 15, 15, 5, 5, -30,
			-40, -20, 0, 5, 5, 0, -20, -40, 
			-50, -35, -30, -30, -30, -30, -35, -50},
		new int[]
		{-20, -10, -10, -10, -10, -10, -10, -20, -10, 0, 0, 0, 0, 0, 0, -10, -10, 0, 5, 10, 10, 5, 0, -10, -10,
			5, 5, 10, 10, 5, 5, -10, -10, 0, 10, 10, 10, 10, 0, -10, -10, 10, 10, 10, 10, 10, 10, -10, 
			-10, 5,0, 0, 0, 0, 5, -10, 
			-20, -10, -10, -10, -10, -10, -10, -20},
		new int[]
		{0, 0, 0, 0, 0, 0, 0, 0, 5, 10, 10, 10, 10, 10, 10, 5, -5, 0, 0, 0, 0, 0, 0, -5, -5, 0, 0,
			0, 0, 0, 0, -5, -5, 0, 0, 0, 0, 0, 0, -5, -5, 0, 0, 0, 0, 0, 0, -5, -5, 0, 0, 0, 0, 0,
			0, -5, 0, 0, 0, 5, 5, 0, 0, 0},
		new int[]
		{-20, -10, -10, -5, -5, -10, -10, -20, -10, 0, 0, 0, 0, 0, 0, -10, -10, 0, 5, 5, 5, 5, 0,
			-10, -5, 0, 5, 5, 5, 5, 0, -5, 0, 0, 5, 5, 5, 5, 0, -5, -10, 5, 5, 5, 5, 5, 0, -10, 
...
new int[]
	...
	public int FullEvaluate(ulong[] bitboards){
		...
		uint lsbIndex;
		for (int a = 0; a < 6; a++) {
			lsbIndex = leastSigLookup [(bitboards [a] * debruijnleast) >> 58];
			value += pieceSquareTable [a] [lsbIndex] + baseValues [a];
			bitboards [a] &= bitboards [a] - 1;
		}
			for (int a = 6; a < 12; a++) {
				lsbIndex = leastSigLookup [(bitboards[a] * debruijnleast) >> 58];
